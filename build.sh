...
sed -i -e "s/url: \"https:\/\/petstore.swagger.io\/v2\/swagger.json\"/urls: [{url: \"sk337.github.io\/SwordBattleOpenApi\/openapi.json\", name:\"SwordBattle.io\"}]/g" dist/swagger-initializer.js
